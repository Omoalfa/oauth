...
class OrganizationService {
  ...
  public createUserOrganization = async (
    ...
    await this.entityManager.transaction(async (manager) => {
      ...
      const designRole = roleRepo.create({
        title: 'Designer Role',
      ...
      const financeRole = roleRepo.create({
        title: 'Finance Role',
      ...
      const advertisingRole = roleRepo.create({
  ...
  public inviteEmployeeToOrganization = async (
    ...
    await this.entityManager.transaction(async (manager) => {
      ...
      const userRole = await userRolesRepo.save(
        userRolesRepo.create({ user, role: { id: roleId } }),
      );
